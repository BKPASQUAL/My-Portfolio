...
function HeroSection() {
  return (
    <div className="bg-bgcolour text-black px-4 sm:px-8 mt-12 sm:mt-12 md:mt-12 md:px-16 lg:px-72 lg:mt-0 h-screen flex flex-col-reverse lg:flex-row items-center">
      {/* Left Section */}
