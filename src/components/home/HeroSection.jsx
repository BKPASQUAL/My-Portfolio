...
function HeroSection() {
  return (
    <div className="bg-bgcolour text-black px-4 sm:px-8 mt-20 pt-4 sm:pt-4 md:pt-4 lg:py-56 md:px-16 lg:px-72 lg:mt-0   flex flex-col-reverse lg:flex-row items-center">
      {/* Left Section */}
